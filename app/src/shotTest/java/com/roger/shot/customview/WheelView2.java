package com.roger.shot.customview;
...
public class WheelView2 extends RelativeLayout {
    ...
    public WheelView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        parentView = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.wheel_view, this, true);
